from models.user_models import CreatedUserResponse, CreateUsersRequest
from marshest.marshclients import MarshClient

from models.user_models_single_user import GetSingleUserResponse
...
class UsersAPIClient(MarshClient):
    ...
    def get_single_users(self,id):                                      #get_single_users GET request
        ...
        return self.request('GET',url,
                            headers=self.default_headers,
                            response_entity_type=GetSingleUserResponse)